...
const val API_KEY = "6e6aea0df2914ce4b2a93342220209"
...
class MainFragment : Fragment() {
    ...
    //список вкладок для переключения
    private val tList = listOf(
        "Hours",
        "Days"
    )
    //спрашивает разрешение на местоположение
    ...
    private fun updateCurrentCard() = with(binding) {
        model.liveDataCurrent.observe(viewLifecycleOwner) {
            ...
            Picasso.get().load("http:" + it.imageUrl).into(imWeather)
        }
    }
